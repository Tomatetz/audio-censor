...
class WebFeaturesTests(unittest.TestCase):
    ...
    def test_dashboard_replaces_large_log_panel(self):
        ...
        self.assertIn('.advanced-grid > div:nth-child(-n+2) .help-tip::after', web_gui.HTML)
        self.assertIn('.advanced-grid > div:nth-child(odd) .help-tip::after', web_gui.HTML)
        self.assertNotIn('class="help-tip" tabindex="0"', web_gui.HTML)
        ...
        self.assertIn('width:max-content; max-width:100%', web_gui.HTML)
